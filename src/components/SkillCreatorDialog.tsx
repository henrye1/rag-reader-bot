...
import type { GeneratedSkillResponse, SkillType, OutputFormat } from "@/integrations/supabase/types";
...
export const SkillCreatorDialog = ({
  ...
  const handleGenerate = async () => {
    ...
    try {
      const { data, error } = await supabase.functions.invoke("create-skill", {
        body: { description, saveSkill: false },
      });
